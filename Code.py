...
finding_country = "SELECT * FROM Country, Medals WHERE Country.country_code = ?;"
# -----------------------------------------------------
...
def removing_country(): #Remove a country
...
def finding_country():#Find a country
    country_code = input("Enter the country code to find: ").upper()
    cursor.execute(finding_country, (country_code,))
